...
public class PastEnergyIndexNodeDialog extends Dialog {
	private Text text;
	 ...
	 * @param parentShell
	 */
	public PastEnergyIndexNodeDialog(Shell parentShell, IndexNodeModel indexNode) {
	...
	public boolean close() {
		...
		myElement.addAttribute(IndexNodeModel.TYPE_ATTR, "".equals(text_1.getText().trim())?null:text_1.getText().trim());
