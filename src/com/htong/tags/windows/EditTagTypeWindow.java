 ...
 * 
 */
public class EditTagTypeWindow extends ApplicationWindow {
	private final Logger log = Logger.getLogger(EditTagTypeWindow.class);
	 ...
	 */
	public EditTagTypeWindow(TagModel tagModel, Text text) {
		super(null);
	...
	protected Control createContents(Composite parent) {
		...
		treeViewer.addCheckStateListener(new ICheckStateListener() {
			...
			public void checkStateChanged(CheckStateChangedEvent event) {
				...
				if (parentO != null) {
					while (parentO != null && !(parentO instanceof String)) {
						rootO = parentO;
...
//				close();
		...
		// 初始化选择
		if(tagModel.getVarName() != null) {//非新建
	...
	public static void main(String args[]) {
		try {
			EditTagTypeWindow window = new EditTagTypeWindow(null, null);
